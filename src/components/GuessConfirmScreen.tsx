  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-neutral-900 bg-background px-4 py-3">
        <button
          onClick={onCancel}
          className="rounded border border-neutral-900 bg-background px-4 py-2 text-xs font-semibold uppercase text-black hover:bg-background"
        >
          Back
        </button>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center space-y-6 bg-background">
        <div className="space-y-3 max-w-md">
          ...
          <div className="rounded border border-neutral-900 bg-background p-4 text-lg font-bold uppercase text-black">
            {shelterName}
          </div>
