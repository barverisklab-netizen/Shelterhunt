      ...
      <div className="w-full max-w-sm rounded-3xl border-4 border-black bg-white p-6 shadow-[8px_8px_0_rgba(0,0,0,0.9)]">
        ...
        <div className="mt-5 flex gap-3">
          <button
            ...
            className="flex-1 rounded-xl border-2 border-black px-4 py-2 text-sm font-bold uppercase tracking-wide text-black transition hover:bg-sky-150 hover:text-black"
          >
