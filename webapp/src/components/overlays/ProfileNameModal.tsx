    ...
    >
      ...
      <div className="mt-6 flex gap-3">
        <button
          ...
          onClick={onClose}
          disabled={submitting}
          className="flex-1 rounded-xl border-2 border-black px-4 py-2 text-sm font-bold uppercase tracking-wide text-black transition hover:bg-sky-150 hover:text-black disabled:opacity-50"
        >
          {t("common.cancel")}
        </button>
        <button
