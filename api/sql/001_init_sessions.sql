...
create table if not exists public.shelters (
  ...
  water_station_250m boolean,
  hospital_250m boolean,
  aed_250m integer,
  emergency_supply_storage_250m integer,
  community_center_250m integer,
  train_station_250m boolean,
  shrine_temple_250m integer,
  floodgate_250m boolean,
  bridge_250m integer,
...
alter table if exists public.shelters
  ...
  add column if not exists water_station_250m boolean,
  add column if not exists hospital_250m boolean,
  ...
  add column if not exists train_station_250m boolean,
  add column if not exists shrine_temple_250m integer,
  add column if not exists floodgate_250m boolean,
